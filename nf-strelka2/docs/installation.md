# NF-Strelka2 Installation

To start using the NF-Strelka2 pipeline, there are three steps described below:
...
This pipeline itself needs no installation - NextFlow will automatically fetch it from GitHub if `afkoeppel/NF-Strelka2` is specified as the pipeline name.
...
```bash
wget https://github.com/afkoeppel/NF-Strelka2/archive/master.zip
unzip master.zip -d /my-pipelines/
cd /my_data/
nextflow run /my-pipelines/nf-strelka2-master
```
